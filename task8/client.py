...
from common.errors import NoMessage
...
def main():
    ...
    receiv_process = threading.Thread(target=message_from_server, args={client_socket, client_name})
    ...
    while True:
        time.sleep(1)
        if receiv_process.is_alive() and user_interface.is_alive():
            continue
        break
